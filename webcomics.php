...
<header>
                    ...
                    <ul class="navbar-nav m-auto text-white">
                        ...
                        <li class="nav-item dropdown me-4">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item text-red fw-bold " href="#">WEBCOMICS</a></li>
                            </ul>
                        </li>
                        <li class="nav-item me-5">
        ...
        <main class="mb-5">
             ...
             <!-- LAPORAN -->
              ...
              <h2 class="text-white text-center">WEBCOMICS</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="media">
                                <h2 class="text-center">COMING SOON</h4>
                                </p>
                                <br>
                            </div>
                            </div>
        ...
        <footer class="" style="background-color: rgb(34, 34, 34); color:#ddd;">
            ...
            <small>v-1.0 | Copyright &copy; DP3A Kota Manado with M.A.Y <?php echo date("Y") ?></small>
            </div>
            <!-- shadow -->
    </footer>
    </div>
